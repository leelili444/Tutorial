...
3.  **Defining the Z-Axis (Up):**
    * The **+Z axis** is defined as pointing vertically upward, perpendicular to the surface of the chip package. (This is the standard convention for MEMS sensors, where a stationary chip reports +1g on the Z-axis.
